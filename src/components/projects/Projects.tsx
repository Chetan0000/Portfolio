...
const Projects: React.FC = () => {
  return (
    <div className="w-[100vw] min-h-[100vh] bg-zinc-800 pt-2 py-5 border-2 border-red-400 overflow-x-hidden">
              ...
              <a href="https://ping-r7s3.onrender.com" target={"_blank"}>
                ...
                >
                  <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 h-[20rem] ">
                    ...
                    <div className="text-base !m-0 !p-0 font-normal w-full">
                      <span className="text-slate-500 ">
                        Obay is a full-fledged e-commerce web application built
                        using the MERN stack and Redux Toolkit for state
